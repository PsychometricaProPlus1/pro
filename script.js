// script.js - Frontend for Psychometrica Pro Plus (v7 - Worker Auth + Local Save + Fixed Admin Plan Gen Scope)
...
// Fix: Made showAlert globally accessible for plan.js.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Utility Functions
    // ========================================================================
     function showAlert(type, message) { // THIS FUNCTION IS NOW ASSIGNED TO window LATER
    ...
    function loadResults() {
        try {
            ...
            allResults = [];
            showAlert('error', 'Failed to load previous results.'); // showAlert will be available here
        }
    }
    ...
    function saveResults() {
        try {
            ...
            showAlert('error', 'Failed to save results.'); // showAlert will be available here
        }
    }
    ...
    function loadStudentInfo() {
        try {
            ...
            allStudentInfo = [];
            showAlert('error', 'Failed to load student information.'); // showAlert will be available here
        }
    }
    ...
    function saveStudentInfo() {
        try {
            ...
            showAlert('error', 'Failed to save student information.'); // showAlert will be available here
        }
    }
    ...
    // *** FIX: Explicitly assign showAlert to window scope ***
    window.showAlert = showAlert;

    // Ensure plan functions (defined in plan.js) are globally accessible
    // Although plan.js likely assigns them, doing it here is safer if load order changes
    ...
    loadResults();
    loadStudentInfo();
    // Removed checkUserSession() as it wasn't defined and likely not needed with worker auth
